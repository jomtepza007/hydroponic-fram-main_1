...
export default function FarmerResources() {
  ...
  function openEdit(r) {
    setEditTarget(r)
    setForm({ name: r.name, type: r.type, unit: r.unit, min_threshold: r.min_threshold, max_qty: r.max_qty || 1000, description: r.description || '' })
    setShowForm(true)
  }
      ...
      <main className="ml-64 flex-1 p-8">
        <div className="max-w-5xl mx-auto">
          <div className="flex items-center justify-between mb-8">
            <div>
              <h1 className="page-title">สต็อกทรัพยากร</h1>
              <p className="page-subtitle">ตรวจสอบและจัดการทรัพยากรการปลูก</p>
            </div>
